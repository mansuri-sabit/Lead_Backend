"""
PaddleOCR bridge for Node.js (Agent 3 LinkedIn image OCR).
Canonical script path: Backend/ocr/paddle_ocr.py
Also available as deepseek_ocr.py for backward compatibility with Agent 2.
